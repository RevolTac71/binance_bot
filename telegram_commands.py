...
async def help_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    msg = (
        ...
        "htf_1h     — 1시간봉 상위 프레임 (str, 예: 1h, 2h, 4h)\n"
        "htf_15m    — 15분봉 상위 프레임 (str, 예: 15m, 30m)\n"
        "adx        — ADX 기본 임계값 (float, 기본 25.0)\n"
        "adx_trend_mult — ADX 상대추세 배수 (float, 범위 0.5~3.0)\n"
        "mtf_lower_mult — MTF 필터 끄기 배수 (float, 범위 0.5~3.0)\n"
        "mtf_upper_mult — MTF 필터 켜기 배수 (float, 범위 0.5~3.0)\n"
